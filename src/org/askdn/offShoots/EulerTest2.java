...
// IMPORTANT ALERT: THE FOLLOWING PROGRAMS UNDER OFFSHOOTS ARE ONLY FOR TEST & ALTERNATIVE SOLUTIONS TO PROBLEMS
...
public class EulerTest2 {
	 ...
	 public static void main(String[] args) {
	    ...
	    // Start of Binet's Formula for finding Fibonacci   
	    double temp = (ROOT5 * (Math.pow(FACTOR,j)));
	    int fib = (int) Math.round(temp);
	    // End
	    
	    System.out.println("The Nth Fibonacci Number= "+fib);
